...
//    public ReachableTilesFinder(IUnitManager unitManager, TileManager map, int initialPathCost = 0) 
//        : base( unitManager.GetSelectedUnit(), 
//                new Node(map.Ground.WorldToCell(unitManager.GetSelectedUnit().WorldPosition)),
//                null,
//                map, 
//                initialPathCost )
//    {
...
//                                                        && !unitManager.GetPositionsOfUnits().ContainsKey(pair.Key.Coordinates))
